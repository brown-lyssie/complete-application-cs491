defmodule GameLibraryWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GameLibraryWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GameLibraryWeb.Gettext, "errors", msg, opts)
    end
  end
